-- Contratos y agenda de recogidas
...
CREATE TABLE agenda_recogida (
  ...
  fecha_programa  TIMESTAMPTZ NOT NULL,
  ventana_horas   INT NOT NULL DEFAULT 2,
  estado          TEXT NOT NULL DEFAULT 'PENDIENTE' CHECK (estado IN ('PENDIENTE','ASIGNADA','REALIZADA','CANCELADA')),
  notas           TEXT
);
CREATE INDEX idx_agenda_programa ON agenda_recogida (fecha_programa);
